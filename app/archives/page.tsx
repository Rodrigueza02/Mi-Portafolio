...
id: 3,
  nombre: "Proyecto 03",
  titulo: "Página de Diseño de Interfaces para Aplicaciones Web",
  descripcion: "Proyecto académico de la UCC que explora los fundamentos del diseño UI/UX para crear experiencias digitales interactivas y memorables.",
  tecnologias: ["HTML5", "Tailwind CSS", "JavaScript", "Figma", "Google Fonts (Inter)"],
  fecha: "2025",
  githubUrl: "https://github.com/DieryValencia/Dise-o-de-interfaces-para-aplicaciones-web.git",
